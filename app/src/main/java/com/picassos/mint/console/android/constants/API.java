...
public class API {
    // api base url
    public static final String API_URL = "http://api2.themintapp.com/v1/console/";
    ...
    public static final String REQUEST_ACCOUNT_DETAILS = "credentials/request_account_details.inc.php";
    public static final String REQUEST_UPDATE_ACCOUNT = "credentials/request_update_account.inc.php";
    public static final String REQUEST_UPDATE_PASSWORD = "credentials/request_update_password.inc.php";
    public static final String REQUEST_LOGIN_WITH_QR = "credentials/request_login_with_qr.inc.php";
    public static final String REQUEST_DELETE_WALKTHROUGH = "walkthrough/request_delete_walkthrough.inc.php";
    ...
    public static final String REQUEST_SEND_NOTIFICATION = "request_send_notification.inc.php";
    ...
    public static final String REQUEST_UPDATE_THEME_STYLE = "request_update_theme_style.inc.php";
    ...
    public static final String REQUEST_ARTICLES = "help_centre/request_articles.inc.php";
    public static final String REQUEST_ARTICLE = "help_centre/request_article.inc.php";
    public static final String REQUEST_COMMENTS = "help_centre/request_comments.inc.php";
    public static final String REQUEST_POST_COMMENT = "help_centre/request_post_comment.inc.php";
    public static final String REQUEST_REMOVE_COMMENT = "help_centre/request_remove_comment.inc.php";
    public static final String REQUEST_REMOVE_PROVIDER = "providers/request_remove_provider.inc.php";
    public static final String REQUEST_UPDATE_COMMENT = "help_centre/request_update_comment.inc.php";
    ...
    public static final String REQUEST_SEND_RESET_EMAIL = "reset_password/request_send_email.inc.php";
    public static final String REQUEST_PROJECTS = "projects/request_projects.inc.php";
    public static final String REQUEST_VERIFY_CODE = "reset_password/request_verify_code.inc.php";
    public static final String REQUEST_RESET_PASSWORD = "reset_password/request_reset_password.inc.php";
    public static final String REQUEST_THEME_STYLE = "request_theme_style.inc.php";
